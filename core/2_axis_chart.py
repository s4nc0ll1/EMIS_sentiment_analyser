...
def plot_sources_comparison(source1_data, source2_data):
    ...
    # --- Sentiment (Source 1) now has style of previous Series ID ---
    ...
    # Highlight zero reference line for sentiment
    ax1.axhline(y=0, color="red", linestyle="-", linewidth=1.5, alpha=0.8)

    # ---- Visual offset for Series ID ----
